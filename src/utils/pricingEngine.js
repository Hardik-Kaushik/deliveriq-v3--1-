...
// Each entry has name (display), area (subtitle), lat, lng
export const BANGALORE_LOCATIONS = [
  { name: 'HSR Layout',        area: 'Bangalore', lat: 12.9116, lng: 77.6474 },
  { name: 'Koramangala',       area: 'Bangalore', lat: 12.9352, lng: 77.6245 },
  { name: 'Indiranagar',       area: 'Bangalore', lat: 12.9719, lng: 77.6412 },
  { name: 'Whitefield',        area: 'Bangalore', lat: 12.9698, lng: 77.7500 },
  { name: 'BTM Layout',        area: 'Bangalore', lat: 12.9166, lng: 77.6101 },
  { name: 'Marathahalli',      area: 'Bangalore', lat: 12.9591, lng: 77.6974 },
  { name: 'Electronic City',   area: 'Bangalore', lat: 12.8399, lng: 77.6770 },
  { name: 'Jayanagar',         area: 'Bangalore', lat: 12.9308, lng: 77.5836 },
  { name: 'JP Nagar',          area: 'Bangalore', lat: 12.9063, lng: 77.5857 },
  { name: 'Hebbal',            area: 'Bangalore', lat: 13.0350, lng: 77.5970 },
  { name: 'Yelahanka',         area: 'Bangalore', lat: 13.1005, lng: 77.5963 },
  { name: 'Bannerghatta Road', area: 'Bangalore', lat: 12.8914, lng: 77.5975 },
  { name: 'Sarjapur Road',     area: 'Bangalore', lat: 12.9102, lng: 77.6784 },
  { name: 'Bellandur',         area: 'Bangalore', lat: 12.9257, lng: 77.6784 },
  { name: 'Domlur',            area: 'Bangalore', lat: 12.9609, lng: 77.6387 },
  { name: 'MG Road',           area: 'Bangalore', lat: 12.9757, lng: 77.6011 },
  { name: 'Brigade Road',      area: 'Bangalore', lat: 12.9713, lng: 77.6074 },
  { name: 'Malleshwaram',      area: 'Bangalore', lat: 13.0035, lng: 77.5670 },
  { name: 'Rajajinagar',       area: 'Bangalore', lat: 12.9958, lng: 77.5530 },
  { name: 'Vijayanagar',       area: 'Bangalore', lat: 12.9719, lng: 77.5308 },
  { name: 'Basavanagudi',      area: 'Bangalore', lat: 12.9425, lng: 77.5741 },
  { name: 'Ulsoor',            area: 'Bangalore', lat: 12.9826, lng: 77.6207 },
  { name: 'Richmond Town',     area: 'Bangalore', lat: 12.9620, lng: 77.5989 },
  { name: 'Shivajinagar',      area: 'Bangalore', lat: 12.9858, lng: 77.6005 },
  { name: 'Yeshwanthpur',      area: 'Bangalore', lat: 13.0225, lng: 77.5351 },
  { name: 'Peenya',            area: 'Bangalore', lat: 13.0284, lng: 77.5178 },
  { name: 'KR Puram',          area: 'Bangalore', lat: 13.0050, lng: 77.6967 },
  { name: 'Banashankari',      area: 'Bangalore', lat: 12.9255, lng: 77.5468 },
  { name: 'Kengeri',           area: 'Bangalore', lat: 12.9079, lng: 77.4830 },
  { name: 'Nagarbhavi',        area: 'Bangalore', lat: 12.9631, lng: 77.5135 },
  { name: 'Cunningham Road',   area: 'Bangalore', lat: 12.9929, lng: 77.5936 },
  { name: 'Frazer Town',       area: 'Bangalore', lat: 12.9906, lng: 77.6193 },
  { name: 'Cox Town',          area: 'Bangalore', lat: 12.9948, lng: 77.6176 },
  { name: 'Banaswadi',         area: 'Bangalore', lat: 13.0111, lng: 77.6479 },
  { name: 'CV Raman Nagar',    area: 'Bangalore', lat: 12.9847, lng: 77.6609 },
  { name: 'HAL Airport Road',  area: 'Bangalore', lat: 12.9569, lng: 77.6478 },
  { name: 'Bommanahalli',      area: 'Bangalore', lat: 12.8944, lng: 77.6404 },
  { name: 'Hennur',            area: 'Bangalore', lat: 13.0435, lng: 77.6395 },
  { name: 'Thanisandra',       area: 'Bangalore', lat: 13.0583, lng: 77.6248 },
  { name: 'Kadugodi',          area: 'Bangalore', lat: 12.9977, lng: 77.7652 },
]
